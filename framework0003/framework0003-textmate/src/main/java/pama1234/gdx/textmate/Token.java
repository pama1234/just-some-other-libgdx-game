...
public class Token implements IToken{
  ...
  /**
   * Creates a new token according to the given specification which does not have any data
   * attached to it.
   *
  ...
  /**
   * Creates a new token which represents neither undefined, whitespace, nor EOF. The newly
   * created token has the given data attached to it.
   *

...
/**
 * Description of textual attributes such as color and style. Text attributes are considered
 * value objects.
 * <p>
...
public class TextAttribute{
   ...
   * @since 3.3
   */
  public TextAttribute(Color foreground,Color background,int style,BitmapFont font) {
    this.foreground=foreground;
    this.background=background;
    this.style=style;
    this.font=font;
  ...
  /**
   * Creates a text attribute for the given foreground color, no background color and with the SWT
   * normal style.
   *
   * @param foreground the foreground color, <code>null</code> if none
   */
  ...
  public boolean equals(Object object) {
    ...
    if(!(object instanceof TextAttribute)) return false;

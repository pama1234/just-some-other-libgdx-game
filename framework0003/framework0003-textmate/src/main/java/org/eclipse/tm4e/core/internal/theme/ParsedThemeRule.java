...
public class ParsedThemeRule{
  ...
  public boolean equals(@Nullable final Object obj) {
    ...
    if(obj instanceof final ParsedThemeRule other) return fontStyle==other.fontStyle
      &&index==other.index
  ...
  public String toString() {
    return "ParsedThemeRule [scope="+scope+", parentScopes="+parentScopes+", index="+index+", fontStyle="+fontStyle+", foreground="+foreground+", background="+background+"]";
  }
}

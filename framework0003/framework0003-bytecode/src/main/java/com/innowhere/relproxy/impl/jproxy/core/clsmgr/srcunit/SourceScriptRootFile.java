...
public abstract class SourceScriptRootFile extends SourceScriptRoot{
  ...
  public static SourceScriptRootFile createSourceScriptRootFile(FileExt sourceFile,FolderSourceList folderSourceList) {
    ...
    if("java".equals(ext)) return new SourceScriptRootFileJavaExt(sourceFile,folderSourceList);
    else return new SourceScriptRootFileOtherExt(sourceFile,folderSourceList); // Caso de archivo script inicial sin extensión .java (puede ser sin extensión)
  }

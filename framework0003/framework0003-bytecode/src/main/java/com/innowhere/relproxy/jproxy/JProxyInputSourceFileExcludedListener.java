...
/**
 * This interface is provided to developers to implement excluding rules to filter source files
 * not to be part of the hot reloading system in spite of included in input paths
 * 

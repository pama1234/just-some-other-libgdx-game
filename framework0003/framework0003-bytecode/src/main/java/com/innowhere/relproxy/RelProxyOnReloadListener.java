 ...
 * 
 * <p>
 * An object implementing this interface can optionally be registered on RelProxy to listen when
 * the method of a proxy object has been called and the class of the original object associated
 * has been reloaded (and a new "original" object based on the new class was created to replace
 * it).
 * </p>
 * 
 * 
...
public interface RelProxyOnReloadListener{
  /**
   * Called when some source code change has happened and a new class has been compiled and
   * reloaded.
   * 

 ...
 * 
 * <p>
 * You are not going to use directly this class, use instead <code>jproxysh</code> command line.
 * </p>
 * 
...
public class JProxyShell{
   ...
   * The main method.
   * 
   * @param args arguments with the necessary data to initialize and executing the provided
   *             script.
   */

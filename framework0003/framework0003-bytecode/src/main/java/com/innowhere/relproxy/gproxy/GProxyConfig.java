...
public interface GProxyConfig{
  ...
  /**
   * Sets the object implementing the <code>GroovyScriptEngine</code> wrapper used to reload
   * Groovy classes.
   * 
   * <p>
   * This parameter is required otherwise there is no bridge between RelProxy and Groovy because
   * there is no explicit Groovy dependency in RelProxy.
   * 

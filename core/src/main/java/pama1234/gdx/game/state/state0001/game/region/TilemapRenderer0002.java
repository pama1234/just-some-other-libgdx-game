...
public class TilemapRenderer0002 implements TilemapRenderer{
  public static final int NUM_VERTICES=20;
  public float unitScale;
  public Batch batch;
  public Rectangle viewBounds;
  public Rectangle imageBounds=new Rectangle();
  public float vertices[]=new float[NUM_VERTICES];
  public TilemapRenderer0002() {}
  @Override
  ...
  public void renderTileLayer(TiledMapTileLayer layer) {
    ...
    for(int row=row2;row>=row1;row--) {
      ...
      for(int col=col1;col<col2;col++) {
        ...
        if(tile!=null) drawRect(color,y,vertices,x,cell,tile);
        x+=layerTileWidth;
      }
      y-=layerTileHeight;
    }
  }
  public void drawRect(final float color,float y,final float[] vertices,float x,final TiledMapTileLayer.Cell cell,final TiledMapTile tile) {

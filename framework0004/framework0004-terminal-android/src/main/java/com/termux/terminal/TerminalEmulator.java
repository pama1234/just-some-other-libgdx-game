...
/**
 * Renders text into a screen. Contains all the terminal-specific knowledge and state. Emulates
 * a subset of the X Window System xterm terminal, which in turn is an emulator for a subset of
 * the Digital Equipment Corporation vt100 terminal.
 * <p>
 * References:
 * <ul>
...
public final class TerminalEmulator{
  ...
  public void setCursorStyle() {
    ...
    if(cursorStyle==null||!Arrays.asList(TERMINAL_CURSOR_STYLES_LIST).contains(cursorStyle)) mCursorStyle=DEFAULT_TERMINAL_CURSOR_STYLE;
   ...
   * 16 parameters per sequence. You must use the ; character to separate parameters. All
  ...
  static final class SavedScreenState{
    /**
     * Saved state of the cursor position, Used to implement the save/restore cursor position escape
     * sequences.
     */

...
final class JNI{
   ...
   * @param envVars   An array of strings of the form "VAR=value" to be added to the environment
   *                  of the process
   ...
   *         will have opened the slave device counterpart (/dev/pts/$N) and have it as stdint,
   *         stdout and stderr.
   */

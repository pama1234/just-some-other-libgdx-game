 ...
 *
 * Implementation from https://github.com/jquast/wcwidth but we return 0 for unprintable
 * characters.
 *
 * IMPORTANT: Must be kept in sync with the following: https://github.com/termux/wcwidth

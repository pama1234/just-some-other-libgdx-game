 ...
 * <p>
 * The subprocess will be executed by the constructor, and when the size is made known by a call
 * to {@link #updateSize(int, int)} terminal emulation will begin and threads will be spawned to
 * handle the subprocess I/O. All terminal emulation and callback methods will be performed on
 * the main thread.
 * <p>

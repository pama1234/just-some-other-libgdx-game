 ...
 * <p>
 * The text in the row is stored in a char[] array, {@link #mText}, for quick access during
 * rendering.
 */
public final class TerminalRow{
  ...
  public void setChar(int columnToSet,int codePoint,long style) {
    if(columnToSet<0||columnToSet>=mStyle.length) throw new IllegalArgumentException("TerminalRow.setChar(): columnToSet="+columnToSet+", codePoint="+codePoint+", style="+style);

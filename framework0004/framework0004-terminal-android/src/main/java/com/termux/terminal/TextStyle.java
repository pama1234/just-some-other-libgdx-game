...
/**
 * <p>
 * Encodes effects, foreground and background colors into a 64 bit long, which are stored for
 * each cell in a terminal row in {@link TerminalRow#mStyle}.
 * </p>
 * <p>
 * The bit layout is:
 * </p>
 * - 16 flags (11 currently used). - 24 for foreground color (only 9 first bits if a color
 * index). - 24 for background color (only 9 first bits if a color index).
 */
public final class TextStyle{
   ...
   * as erasable.
   * <p>
   * This bit is set if DECSCA (Select Character Protection Attribute) has been used to define the
   * characters that come after it as erasable from the screen.
   * </p>
   */

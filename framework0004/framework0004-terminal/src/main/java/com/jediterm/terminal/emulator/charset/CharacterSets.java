...
public final class CharacterSets{
  ...
  public static final Object[][] C1_CHARS= {{0,null}, //
    ...
    {0,"apc"}};
  /**
   * The DEC special characters (only the last 32 characters). Contains [light][heavy] flavors for
   * box drawing
   */
  ...
  // METHODS
  /**
   * Returns the character mapping for a given original value using the given graphic sets GL and
   * GR.
   *
  ...
  /**
   * Returns the mapping for a given character using the given graphic sets GL and GR.
   *
   * @param original the original character to map;
   * @param gl       the GL graphic set, cannot be <code>null</code>;
   * @param gr       the GR graphic set, cannot be <code>null</code>.

...
public class TerminalPanel extends JComponent implements TerminalDisplay,TerminalActionProvider{
  ...
  /**
   * @param keepLastLine true to keep last line (e.g. to keep terminal prompt) false to clear
   *                     entire terminal panel (relevant for terminal console)
   */
   ...
   * @param useSystemSelectionClipboardIfAvailable true to use
   *                                               {@link Toolkit#getSystemSelection()} if
   *                                               available
   */

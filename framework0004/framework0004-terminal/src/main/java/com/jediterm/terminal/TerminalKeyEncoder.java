...
public class TerminalKeyEncoder{
  ...
  /**
   * Refer to section PC-Style Function Keys in
  ...
  /**
   *
   * Code Modifiers ------+-------------------------- 2 | Shift 3 | Alt 4 | Shift + Alt 5 |
   * Control 6 | Shift + Control 7 | Alt + Control 8 | Shift + Alt + Control 9 | Meta 10 | Meta +
   * Shift 11 | Meta + Alt 12 | Meta + Alt + Shift 13 | Meta + Ctrl 14 | Meta + Ctrl + Shift 15 |
   * Meta + Ctrl + Alt 16 | Meta + Ctrl + Alt + Shift ------+--------------------------
   * 
   * @param modifiers
   * @return
   */

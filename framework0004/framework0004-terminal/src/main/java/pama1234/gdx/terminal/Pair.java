...
public class Pair<K,V> implements Serializable{
   ...
   *
   * <p>
   * If the <code>Object</code> to be tested is not a <code>Pair</code> or is <code>null</code>,
   * then this method returns <code>false</code>.
   * </p>
   *
   * <p>
   * Two <code>Pair</code>s are considered equal if and only if both the names and values are
   * equal.
   * </p>
   *

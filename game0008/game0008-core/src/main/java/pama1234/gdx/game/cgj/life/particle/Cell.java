...
public class Cell extends Entity<Screen0045>{
  ...
  public Cell(Screen0045 p,CellCenter parent,int meta,float x,float y) {
    super(p);
    this.parent=parent;
    this.meta=meta;
  ...
  public void display() {
    ...
    else p.fill(colorCache,(int)(colorCache.a*(255-UtilMath.constrain(GameManager.select.point.pos.dist(point.pos),0,255))));
    if(parent.boxed) {
      p.circle(

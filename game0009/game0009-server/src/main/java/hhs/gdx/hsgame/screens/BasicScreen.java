...
public abstract class BasicScreen extends UtilScreen2D{
  ...
  public BasicScreen() {
    ...
    stage=new Stage(new ScalingViewport(Scaling.fit,Resource.width,Resource.height,new OrthographicCamera()),Resource.stageBatch);
    stageFlag=true;
...
//    if(imageBatch!=null) imageBatch.dispose();
  ...
  public void addEntity(Entity e) {
    e.screen=this;
    if(e instanceof BasicEntity be) {
      be.setCam(camera);
    }
    entities.add(e);
  }

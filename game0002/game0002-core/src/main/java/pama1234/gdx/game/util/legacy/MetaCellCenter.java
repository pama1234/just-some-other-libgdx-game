...
public class MetaCellCenter extends EntityCenter<RealGame,MetaCell>{
  ...
  private Color color_1=UtilScreenColor.newColorFromInt(0xff6D5CB7);
  public MetaCellCenter(RealGame p,int x,int y,int w,int h) {
    super(p);
    this.x=x;
    this.y=y;
  ...
  public void refreshLayer() {
    ...
    final float tx1=tyc.point.pos.x,
      ty1=tyc.point.pos.y;
    p.circle(tx1,ty1,MetaCell.size);

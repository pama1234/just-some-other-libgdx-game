...
// import pama1234.game.app.server.server0005.JdbcPersonManage;
 ...
 */
// @Service
public class JdbcPersonManageImpl{
  // implements JdbcPersonManage {
  ...
  // String sql = "insert into person(id,name,age,birthday) values(?,?,?,to_date(?,'yyyy-mm-dd
  // hh24:mi:ss'))";

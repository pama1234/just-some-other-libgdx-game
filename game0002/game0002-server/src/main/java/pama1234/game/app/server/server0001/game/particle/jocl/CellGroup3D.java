package pama1234.game.app.server.server0001.game.particle.jocl;
...
public class CellGroup3D{
  ...
  public static String doTest() {
    ...
    String out="Test "+(passed?"PASSED":"FAILED")+"\n";
    if(n<=10) {
      out+="Result: "+Arrays.toString(dstArray)+"\n";
    }
    return out;
  }
}

...
public final class ClientGameSystem extends ServerGameSystem{
  ...
  public ClientGameSystem(Duel duel,Game pg,boolean demo,boolean instruction,float level) {
    ...
    final DoTeleportPlayerActorState doTeleportState=new ClientDoTeleportPlayerActorState(duel);
    ...
    ClientPlayerActor myPlayer=new ClientPlayerActor(duel,myEngine,duel.config.mode==ServerConfigData.neat?duel.theme.player_b:duel.theme.player_a);

...
import pama1234.server.game.app.server0002.game.block.MetaBlockData;
import pama1234.server.game.app.server0002.game.metainfo.MetaInfoBase;
import pama1234.server.game.app.server0002.game.metainfo.center.MetaItemCenter0002;

@Deprecated
public class MetaItemDataDepc extends MetaInfoBase{
  ...
  public MetaItemDataDepc(MetaItemCenter0002 pc,String name,int id,InitFunction initer) {
    super(name,id);
    this.pc=pc;
    this.name=name;
    this.initer=initer;
  ...
  public interface InitFunction{
    public void init(MetaItemDataDepc in);
  }

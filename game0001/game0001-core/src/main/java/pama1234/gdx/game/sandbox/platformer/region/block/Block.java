...
import pama1234.gdx.game.sandbox.platformer.metainfo.MetaBlock.FullBlockType;
import pama1234.gdx.game.sandbox.platformer.metainfo.MetaBlock.ItemDropAttr;
...
public class Block{
  ...
  public void init(WorldBase2D<?> world,MetaBlock<?,?> type) {
    if(type.attr.displayTypeSize>0) {
      displayType=new int[type.attr.displayTypeSize];
  ...
  public static boolean isEmpty(Block in) {
    return in==null||in.type==null||in.type.attr.empty;//TODO
  }
  public static boolean isNotFullBlock(Block in) {
    return in==null||in.type==null||in.type.attr.empty||!in.type.attr.fullBlock;//TODO
  }
  public static boolean isNotFullBlockFloor(Block in) {
    return in==null||in.type==null||((in.type.attr.empty||!in.type.attr.fullBlock)&&in.type.attr.fullBlockType!=FullBlockType.platformType);//TODO
  }
  public static boolean isFullBlockOrNull(Block in) {
    return in==null||!(in.type==null||in.type.attr.empty||!in.type.attr.fullBlock);
  }
  ...
  public void doItemDrop(World0001 world,Screen0011 p,int x,int y,boolean empty) {
    ...
    for(ItemDropAttr e:type.rttr.itemDrop) DroppedItem.dropItem(p,x,y,world,upEmpty,randomConst,e.item.createItem(e.dropNumber(world)));
  }

...
public class LightBlock extends MetaBlock<WorldType0001Base<?>,MetaBlockCenter0001<WorldType0001Base<?>>>{
  public LightBlock(MetaBlockCenter0001<WorldType0001Base<?>> pc,int id) {
    super(pc,"light-block",id,20,2,(world,in,type,x,y)-> {//change to me
      // in.lighting=16;
      in.light.set(16);
  ...
  public void initItemDrop() {
    rttr.itemDrop=new ItemDropAttr[] {new ItemDropAttr(pc.pwt.metaItems.lightBlock,1)};
  }
  @Override
  public void init() {

...
public class EvolveOptions{
   ...
   */
  private GetFloatWith<Genome> fitnessFunction;
  /**
  ...
  public EvolveOptions() {
    ...
    this.setSelector(new Selector.FitnessProportionate());
   ...
   */
  public GetFloatWith<Genome> getFitnessFunction() {
   ...
   */
  public EvolveOptions setFitnessFunction(final GetFloatWith<Genome> fitnessFunction) {
   ...
   * @return itself to function as builder class
   */
  public EvolveOptions setSelector(final Selector selection) {
   ...
   * @return itself to function as builder class
   */
  public EvolveOptions setTemplate(final Genome template) {

...
public class FirstRun extends StateEntity0002{
  float time;
  // float time=30;
  boolean moveCam;
  public FirstRun(Screen0012 p) {
    super(p);
    TvgAsset.load_temp();
  ...
  public void from(State0002 in) {
    MusicAsset.alsoSprachZarathustra.setOnCompletionListener(music->p.state(State0002.Loading));

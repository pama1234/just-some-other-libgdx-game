...
import pama1234.game.app.server.server0002.Server0004;

public class ScannerThread extends Thread{
  public Server0004 p;
  public Scanner scanner;
  public CommandList commandList;
  public ScannerThread(Server0004 p) {
    super("ScannerThread");
    this.p=p;
  ...
  public interface Command{
    public void execute(Server0004 p,CommandList parent,String[] data,int pointer,int maxStep);
  }
  public static class CommandList implements Command{
    ...
    public void executeSub(Server0004 p,CommandList parent,String[] data,int pointer,int maxStep) {

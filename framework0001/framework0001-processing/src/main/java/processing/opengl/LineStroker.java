...
/*
 * Copyright (c) 2007, Oracle and/or its affiliates. All rights reserved. DO NOT ALTER OR REMOVE
 * COPYRIGHT NOTICES OR THIS FILE HEADER.
 *
 * This code is free software; you can redistribute it and/or modify it under the terms of the
 * GNU General Public License version 2 only, as published by the Free Software Foundation.
 * Oracle designates this particular file as subject to the "Classpath" exception as provided by
...
public class LineStroker{
  ...
  /**
   * Empty constructor. <code>setOutput</code> and <code>setParameters</code> must be called prior
   * to calling any other methods.
   */
  public LineStroker() {}
  /**
   ...
   * @param joinStyle  the desired line join style, one of <code>JOIN_MITER</code>,
   *                   <code>JOIN_ROUND</code> or <code>JOIN_BEVEL</code>.
   * @param miterLimit the desired miter limit, in S15.16 format.
   * @param transform  a <code>Transform4</code> object indicating the transform that has been
   *                   previously applied to all incoming coordinates. This is required in order
   *                   to produce consistently shaped end caps and joins.
   */

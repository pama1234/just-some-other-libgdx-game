...
public class PJOGL extends PGL{
  ...
  /**
   * Convenience method to get a legit FontMetrics object. Where possible, override this any
   * renderer subclass so that you're not using what's returned by getDefaultToolkit() to get your
   * metrics.
   */
   ...
   */
  FontRenderContext getFontRenderContext(Font font) { // ignore
    return getFontMetrics(font).getFontRenderContext();
  }
  /*
   * @Override protected int getFontAscent(Object font) { return getFontMetrics((Font)
   * font).getAscent(); }
   * 
   * 
   * @Override protected int getFontDescent(Object font) { return getFontMetrics((Font)
   * font).getDescent(); }
   */
  @Override
  ...
  // Tessellator
  @Override
  protected Tessellator createTessellator(TessellatorCallbackInterface callback) {
  ...
  protected FontOutline createFontOutline(char ch,Object font) {
    return new FontOutline(this,ch,(Font)font);
  }
  ///////////////////////////////////////////////////////////
  // Constants
  static {

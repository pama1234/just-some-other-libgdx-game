...
/**
 * Encapsulates a Frame Buffer Object for offscreen rendering. When created with onscreen ==
 * true, it represents the normal framebuffer. Needed by the stack mechanism in OPENGL2 to
 * return to onscreen rendering after a sequence of pushFramebuffer calls. It transparently
 * handles the situations when the FBO extension is not available.
 *
 * By Andres Colubri.
 */

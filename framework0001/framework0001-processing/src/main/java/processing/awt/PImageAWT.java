...
public class PImageAWT extends PImage{
   ...
   *
   * @nowebref
   * @param img assumes a MediaTracker has been used to fully download the data and the img is
   *            valid
   */
  ...
  /*
   * @Override protected boolean saveImpl(String path) { return ShimAWT.saveImage(this, path); }
   */
}
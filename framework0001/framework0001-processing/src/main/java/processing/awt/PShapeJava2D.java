...
/**
 * Implements features for PShape that are specific to AWT and Java2D. At the moment, this is
 * gradients and java.awt.Paint handling.
 */
public class PShapeJava2D extends PShapeSVG{
  ...
  /*
   * @Override public void setColor(String colorText, boolean isFill) { super.setColor(colorText,
   * isFill);
   * 
   * if (fillGradient != null) { fillGradientPaint = calcGradientPaint(fillGradient); } if
   * (strokeGradient != null) { strokeGradientPaint = calcGradientPaint(strokeGradient); } }
   */

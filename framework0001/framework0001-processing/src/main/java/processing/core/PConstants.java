 ...
 * 
 * Copyright (c) 2004-11 Ben Fry and Casey Reas Copyright (c) 2001-04 Massachusetts Institute of
 * Technology
 * 
 ...
 * <P>
 * An attempt is made to keep the constants as short/non-verbose as possible. For instance, the
 * constant is TIFF instead of FILE_TYPE_TIFF. We'll do this as long as we can get away with it.
 *
...
public interface PConstants{
  ...
  /*
   * // List of renderers used inside PdePreprocessor static final StringList rendererList = new
   * StringList(new String[] { "JAVA2D", "JAVA2D_2X", "P2D", "P2D_2X", "P3D", "P3D_2X", "OPENGL",
   * "E2D", "FX2D", "FX2D_2X", // experimental "LWJGL.P2D", "LWJGL.P3D", // hmm "PDF" // no DXF
   * because that's only for beginRaw() });
   */
  ...
  /**
   * Same as Float.MAX_VALUE, but included for parity with MIN_VALUE, and to avoid teaching static
   * methods on the first day.
   */
  float MAX_FLOAT=Float.MAX_VALUE;
  /**
   * Note that Float.MIN_VALUE is the smallest <EM>positive</EM> value for a floating point
   * number, not actually the minimum (negative) value for a float. This constant equals
   * 0xFF7FFFFF, the smallest (farthest negative) value a float can have before it hits NaN.
   */
  ...
  /**
   *
   * <b>PI</b> is a mathematical constant with the value 3.1415927. It is the ratio of the
   * circumference of a circle to its diameter. It is useful in combination with the trigonometric
   * functions <b>sin()</b> and <b>cos()</b>.
   *
   * @webref constants
  ...
  /**
   *
   * <b>HALF_PI</b> is a mathematical constant with the value 1.5707964. It is half the ratio of
   * the circumference of a circle to its diameter. It is useful in combination with the
  ...
  /**
   *
   * <b>QUARTER_PI</b> is a mathematical constant with the value 0.7853982. It is one quarter the
   * ratio of the circumference of a circle to its diameter. It is useful in combination with the
   * trigonometric functions <b>sin()</b> and <b>cos()</b>.
   *
   * @webref constants
  ...
  /**
   *
   * <b>TWO_PI</b> is a mathematical constant with the value 6.2831855. It is twice the ratio of
   * the circumference of a circle to its diameter. It is useful in combination with the
   * trigonometric functions <b>sin()</b> and <b>cos()</b>.
   *
   * @webref constants
  ...
  /**
   *
   * <b>TAU</b> is a mathematical constant with the value 6.2831855. It is the circle constant
   * relating the circumference of a circle to its linear dimension, the ratio of the
   * circumference of a circle to its radius. It is useful in combination with trigonometric
   * functions such as <b>sin()</b> and <b>cos()</b>.
   *
   * @webref constants
  ...
  /**
   * textMode(MODEL) is the default, meaning that characters will be affected by transformations
  ...
  int MODEL=4;
  /**
   * textMode(SHAPE) draws text using the the glyph outlines of individual characters rather than
   * as textures. If the outlines are not available, then textMode(SHAPE) will be ignored and
   * textMode(MODEL) will be used instead. For this reason, be sure to call textMode()
   * <EM>after</EM> calling textFont().
   * <p/>
   * Currently, textMode(SHAPE) is only supported by OPENGL mode. It also requires Java 1.2 or
   * higher (OPENGL requires 1.4 anyway)
   */
  int SHAPE=5;

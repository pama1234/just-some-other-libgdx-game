 ...
 * 
 * Copyright (c) 2012-2014 The Processing Foundation Copyright (c) 2007-2012 Ben Fry and Casey
 * Reas
 * 
 ...
 *
 * We have to register a quit handler to safely shut down the sketch, otherwise OS X will just
 * kill the sketch when a user hits Cmd-Q. In addition, we have a method to set the dock icon
 * image, so we look more like a native application.
 *
...
public class ThinkDifferent{
   ...
   *
   * Initialize the sketch with the quit handler such that, if there is no known crash, the
   * application will not exit on its own if this is the first quit attempt.
   *

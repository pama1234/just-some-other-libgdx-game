...
public class Event{
  ...
  /**
   * Get the platform-native event object. This might be the java.awt event on the desktop, though
   * if you're using OpenGL on the desktop it'll be a NEWT event that JOGL uses. Android events
   * are something else altogether. Bottom line, use this only if you know what you're doing, and
   * don't make assumptions about the class type.
   */

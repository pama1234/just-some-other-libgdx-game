...
public class StringDict{
  ...
  /**
   * Create a new lookup pre-allocated to a specific length. This will not change the size(), but
   * is more efficient than not specifying a length. Use it when you know the rough size of the
  ...
  /**
   * Create a dictionary that maps between column titles and cell entries in a TableRow. If two
   * columns have the same name, the later column's values will override the earlier values.
   */

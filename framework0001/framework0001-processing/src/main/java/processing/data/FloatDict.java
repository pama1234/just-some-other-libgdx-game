...
/**
 * A simple class to use a <b>String</b> as a lookup for a float value. String "keys" are
 * associated with floating-point values.
 *
 * @webref data:composite
 * @webBrief A simple table class to use a <b>String</b> as a lookup for a float value
 * @see IntDict
 * @see StringDict
 */
public class FloatDict{
   ...
   * values into it. The version with the <b>float[]</b> parameters fills an already-allocated
   * array with the values (more efficient than creating a new array each time). If 'array' is
   * null, or not the same size as the number of values, a new array will be allocated and
   * returned.
   *
   * @webref floatdict:method

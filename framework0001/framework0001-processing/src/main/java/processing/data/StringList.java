...
/**
 * Helper class for a list of <b>String</b> objects. Lists are designed to have some features of
...
public class StringList implements Iterable<String>{
  ...
  /**
   * Construct a StringList from a random pile of objects. Null values will stay null, but all the
   * others will be converted to String values.
   *
   * @nowebref
   */
   ...
   * expand the list to accommodate, and fill the intermediate entries with <b>null</b>.
   *
   * @webref stringlist:method
  ...
  /**
   * A sort in reverse. It's equivalent to running <b>sort()</b> and then <b>reverse()</b>, but is
   * more efficient than running each separately.
   *
   * @webref stringlist:method
  ...
  /**
   * Return a random value from the list. Throws an exception if there are no entries available.
   * (Can't just return null because IntList and FloatList can't do that, and would be
   * inconsistent.)
   */
  ...
  /**
   * Returns the actual array being used to store the data. Suitable for iterating with a for()
   * loop, but modifying the list could cause terrible things to happen.
   */

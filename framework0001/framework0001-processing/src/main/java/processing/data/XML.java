 ...
 * 
 * Copyright (c) 2012 The Processing Foundation Copyright (c) 2009-12 Ben Fry and Casey Reas
 * 
 ...
 * <b>loadXML()</b> to load external XML files and create <b>XML</b> objects.<br />
 * <br />
 * Only files encoded as UTF-8 (or plain ASCII) are parsed properly; the encoding parameter
 * inside <b>XML</b> files is ignored.
 *
 * @webref data:composite
 * @webBrief This is the base class used for the Processing XML library, representing a single
 *           node of an <b>XML</b> tree
...
public class XML implements Serializable{
  ...
  //  }
  /**
   * Advanced users only; use loadXML() in PApplet. This is not a supported function and is
   * subject to change. It is available simply for users that would like to handle the exceptions
   * in a particular way.
   *
   * @nowebref
   */
   ...
   * Advanced users only; use loadXML() in PApplet.
   *
   * Added extra code to handle \u2028 (Unicode NLF), which is sometimes inserted by web browsers
  ...
  /**
   * Checks whether or not the element has any children, and returns the result as a
   * <b>boolean</b>.
   *
   * @webref xml:method
  ...
  /**
   * Get the names of all of the element's children, and returns the names as an array of
   * <b>Strings</b>. This is the same as looping through and calling <b>getName()</b> on each
  ...
  /**
   * Returns all of the element's children as an array of <b>XML</b> objects. When the <b>name</b>
   * parameter is specified, then it will return all children that match that name or path. The
   * path is a series of elements and sub-elements, separated by slashes.
   *
   * @webref xml:method
  ...
  /**
   * Returns the first of the element's children that matches the <b>name</b> parameter. The name
   * or path is a series of elements and sub-elements, separated by slashes.
   *
   * @webref xml:method
  ...
  /**
   * Appends a new child to the element. The child can be specified with either a <b>String</b>,
   * which will be used as the new tag's name, or as a reference to an existing <b>XML</b>
   * object.<br />
   * <br />
  ...
  /**
   * Removes the specified element. First use <b>getChild()</b> to get a reference to the desired
   * element. Then pass that reference to <b>removeChild()</b> to delete it.
   *
   * @webref xml:method
  ...
  /**
   * Removes whitespace nodes. Those whitespace nodes are required to reconstruct the original
   * XML's spacing and indentation. If you call this and use saveXML() your original spacing will
   * be gone.
   * 
   * @nowebref
  ...
  /**
   * Gets all of the specified element's attributes, and returns them as an array of
   * <b>Strings</b>.
   *
   * @webref xml:method
  ...
  /**
   * Checks whether or not an element has the specified attribute. The attribute must be specified
   * as a <b>String</b>, and a <b>boolean</b> is returned.
   *
   * @webref xml:method
   ...
   * parameter is specified and the attribute doesn't exist, then <b>defaultValue</b> is returned.
   * If no <b>defaultValue</b> is specified and the attribute doesn't exist, <b>null</b> is
   * returned.
   *
   * @webref xml:method
   ...
   * parameter is specified and the attribute doesn't exist, then <b>defaultValue</b> is returned.
   * If no <b>defaultValue</b> is specified and the attribute doesn't exist, the value 0 is
   * returned.
   *
   * @webref xml:method
  ...
  /**
   * Sets the content of an element's attribute as an <b>int</b>. A <b>String</b> specifies the
   * attribute name, while the int specifies the new content.
   *
   * @webref xml:method
  ...
  /**
   * Returns an attribute value of the element as a float. If the <b>defaultValue</b> parameter is
   * specified and the attribute doesn't exist, then <b>defaultValue</b> is returned. If no
   * <b>defaultValue</b> is specified and the attribute doesn't exist, the value 0.0 is returned.
   *
   * @webref xml:method
  ...
  /**
   * Sets the content of an element's attribute as a <b>float</b>. A <b>String</b> specifies the
   * attribute name, while the <b>float</b> specifies the new content.
   *
   * @webref xml:method
  ...
  /**
   * Returns the content of an element as an <b>int</b>. If there is no such content, either
   * <b>null</b> or the provided default value is returned.
   *
   * @webref xml:method
  ...
  /**
   * Returns the content of an element as a <b>float</b>. If there is no such content, either
   * <b>null</b> or the provided default value is returned.
   *
   * @webref xml:method
   ...
   * <br />
   * If indent is set to -1, then the String is returned with no line breaks, no indentation, and
   * no <b>XML</b> declaration.<br />
   * <br />
   * If indent is set to 0 or greater, then the <b>String</b> is returned with line breaks, and
   * the specified number of spaces as indent values. Meaning, there will be no indentation if 0
   * is specified, or each indent will be replaced with the corresponding number of spaces: 1, 2,
   * 3, and so on.
   *
   * @webref xml:method
  ...
  /**
   * Takes an <b>XML</b> object and converts it to a <b>String</b>, using default formatting rules
   * (includes an XML declaration, line breaks, and two spaces for indents). These are the same
   * formatting rules used by <b>println()</b> when printing an <b>XML</b> object. This method
   * produces the same results as using <b>format(2)</b>.
   *
   * @webref xml:method

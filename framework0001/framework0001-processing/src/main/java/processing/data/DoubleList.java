...
/**
 * Helper class for a list of <b>double</b> values. Lists are designed to have some features of
...
public class DoubleList implements Iterable<Double>{
  ...
  /**
   * Construct an FloatList from an iterable pile of objects. For instance, a double array, an
   * array of strings, who knows. Un-parsable or null values will be set to NaN.
   * 
   * @nowebref
   */
  @SuppressWarnings("unused")
  ...
  /**
   * Randomize the order of the list elements. Note that this does not obey the randomSeed()
   * function in PApplet.
   *
   * @webref doublelist:method
   ...
   * classes. It's a getter method because it needs to return a new list (because IntList/Dict

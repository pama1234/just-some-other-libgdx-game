...
/**
 * Helper class for a list of <b>float</b> values. Lists are designed to have some features of
...
public class FloatList implements Iterable<Float>{
  ...
  /**
   * Construct an FloatList from an iterable pile of objects. For instance, a float array, an
  ...
  /**
   * Construct an FloatList from a random pile of objects. Un-parsable or null values will be set
   * to NaN.
   */

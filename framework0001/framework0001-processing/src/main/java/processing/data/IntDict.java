...
public class IntDict{
  ...
  /**
   * Create a new lookup with a specific size. This is more efficient than not specifying a size.
  ...
  /**
   * Read a set of entries from a Reader that has each key/value pair on a single line, separated
   * by a tab.
   *
   * @nowebref
   */
  ...
  /**
   * Resize the internal data, this can only be used to shrink the list. Helpful for situations
   * like sorting and then grabbing the top 50 entries.
   */
  ...
  /**
   * Return a copy of the internal keys array. In contrast to the <b>keys()</b> method, this array
   * can be modified.
   *
   * @webref intdict:method
  ...
  /**
   * The version of this method without a parameter creates a new array and copies each of the
   * values into it. The version with the <b>int[]</b> parameters fills an already-allocated array
   * with the values (more efficient than creating a new array each time). If 'array' is null, or
   * not the same size as the number of values, a new array will be allocated and returned.
   *
   * @webref intdict:method
  ...
  /**
   * Fill an already-allocated array with the values (more efficient than creating a new array
   * each time). If 'array' is null, or not the same size as the number of values, a new array
  ...
  /**
   * Merge another dictionary into this one. Calling this increment() since it doesn't make sense
   * in practice for the other dictionary types, even though it's technically an add().
   */
  ...
  /**
   * Add to a value. If the key does not exist, an new pair is initialized with the value
   * supplied.
   * 
   * @webref intdict:method
  ...
  /**
   * Sort the keys alphabetically (ignoring case). Uses the value as a tie-breaker (only really
   * possible with a key that has a case change).
   *
   * @webref intdict:method
  ...
  /**
   * Sort the keys alphabetically in reverse (ignoring case). Uses the value as a tie-breaker
   * (only really possible with a key that has a case change).
   *
   * @webref intdict:method
  ...
  /**
   * Set true to ensure that the order returned is identical. Slightly slower because the
   * tie-breaker for identical values compares the keys.
   * 
   * @param stable
   */
  ...
  /**
   * Sum all of the values in this dictionary, then return a new FloatDict of each key, divided by
   * the total sum. The total for all values will be ~1.0.
   * 
